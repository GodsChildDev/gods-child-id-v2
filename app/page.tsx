            ...
            <Card className="mt-4" style={{ background: 'lightyellow' }}>
                ...
                >
                    <div>
                        ...
                        <CardContent>
                            <div className="row text-center" style={{ background: 'darkgray' }}>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'inline-flex' }}>
                            ...
                            <CardContent className="textBox text-left">
                                ...
                                <br />
                                <ol>
                                    <li><LockKeyhole color={'gold'} size={24} />Register for a new account on our <a href="/signup">signup</a> page.</li>
                                    <li><LockKeyhole color={'gold'} size={24} /><span>Once you have logged in, you will be directed to the settings page where you will be directed to enter your access code. Enter your access code and click save. If your code is entered correctly , you will be granted full access. <b>You may need to refresh your screen for changes to take effect.</b></span></li>
                                    <li><LockKeyhole color={'gold'} size={24} />Setup two factor authentication to enable additional security measures via email or text keeping your childrens information safe and secure.</li>
                                    <li><LockKeyhole color={'gold'} size={24} />You will receive an email from God’s Child ID three times a year reminding you to update your children’s information.</li>
                                </ol>
                            </CardContent>
                        </div></div>
                        <div>
                        ...
                        <div style={{ display: 'inline-flex' }}>
                            ...
                            <CardContent className="textBox text-left">
                                <ol>
                                    <li><Siren color={'red'} size={24} />Contact Law Enforcement by dialing 911. Inform them of your situation and let them know you have a digital ID Kit with your child’s picture and their information. Ask them if you should text or email it to them.</li>
                                    <li><Siren color={'red'} size={24} />Go to that child’s information under My Children’s Page and click on the Flier Icon underneath that child’s info. Add your child’s name and information such as what they are wearing, where last seen etc.</li>
                                    <li><Siren color={'red'} size={24} />Once this is done click on the Green Flier Icon and then choose Text, Email, Share to Facebook or Print. (You can always come back and choose the other options after its first sent to Law Enforcement). Make sure that you give law enforcement your unique child identifier which is listed on the flier once generated. If you choose text , you will receive a text message with the link to the flier. Once you have received the link , forward this link to anyone you may want to share with including 911.</li>
                                    <li><Siren color={'red'} size={24} />If you’re at an amusement park, state or national park quickly find their security or park rangers and text the Flier to them so their entire team can BOLO for you’re child.</li>
                                </ol>
