        ...
        {type === 'text' &&
          <div style={{ marginTop: '20px' }}>
            <h3 style={{ color: 'black', fontWeight: 100, fontStyle: 'italic', fontSize: '0.85rem', lineHeight: '1.4' }}>
              ...
              &nbsp;<Link href="https://www.godschildid.com/terms" target="_blank" style={{ color: 'blue', textDecoration: 'underline' }}>Terms</Link> 
              &nbsp;&&nbsp;
              <Link href="https://www.godschildid.com/privacy" target="_blank" style={{ color: 'blue', textDecoration: 'underline' }}>Privacy</Link>.
            </h3>
            <br />
