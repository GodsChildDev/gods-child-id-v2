            ...
            <Card className="mt-4" style={{ background: 'lightyellow' }}>
                <CardHeader>
                    <CardTitle style={{color: 'darkgoldenrod'}}>ATTENTION Parent / Guardian: <br/>
                        <span style={{fontWeight: 'lighter'}}>After adding your family members below, you may generate shareable flyers. This action will ask you to enter your loved one's name and some details about their disappearance. Note: while this site is primarily poised for protecting children, it may also be used to protect your elderly.
                        </span>
                    </CardTitle>
                </CardHeader>
                <CardContent>
